import {go} from './node_modules/gojs/release/go-module.js';
...
function load() {
  let initVal = `{ "class": "GraphLinksModel",
  "linkFromPortIdProperty": "fromPort",
  "linkToPortIdProperty": "toPort",
  "modelData": {"position":"-466 -5"},
  "nodeDataArray": [],
  "linkDataArray": []}`;
  myDiagram.model = go.Model.fromJson(initVal);
